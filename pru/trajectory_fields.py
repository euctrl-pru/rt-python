...
POSITION_METRICS_FIELDS = "FLIGHT_ID,PROFILE_TYPE,AV_PERIOD," \
    "CLIMB_AV_PERIOD,CRUISE_AV_PERIOD,DESCENT_AV_PERIOD,IS_UNORDERED," \
    "TIME_SD,TIME_MAX,TIME_MAX_INDEX,XT_SD,XT_MAX,XT_MAX_INDEX,ALT_SD,ALT_MAX,\n"
""" The fields of a positions metrics record. """

NEW_ID_FIELDS = 'FLIGHT_ID,NEW_FLIGHT_ID\n'
""" The fields of a new flight ids record. """

AIRSPACE_INTERSECTION_FIELDS = 'FLIGHT_ID,SECTOR_ID,IS_EXIT,LAT,LON,ALT,TIME,DISTANCE\n'
""" The fields of an airspace intersections record. """

AIRPORT_INTERSECTION_FIELDS = 'FLIGHT_ID,AIRPORT_ID,RADIUS,IS_DESTINATION,LAT,LON,ALT,TIME,DISTANCE\n'
""" The fields of an airspace intersections record. """
