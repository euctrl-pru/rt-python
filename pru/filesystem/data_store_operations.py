...
from pru.trajectory_files import APDS, CPR, FR24, CPR_FR24, APDS_CPR_FR24, IDS, \
    FLEET_DATA, ERROR_METRICS, TRAJECTORIES, TRAJ_METRICS, SYNTH_POSITIONS, \
...
REFINED_CPR = '/'.join([REFINED, CPR])
REFINED_FR24 = '/'.join([REFINED, FR24])
REFINED_APDS = '/'.join([REFINED, APDS])

DAILY = 'daily'
DAILY_CPR_FR24 = '_'.join([DAILY, CPR_FR24])

REFINED_MERGED_DAILY_CPR_FR24 = '/'.join([REFINED, MERGED, DAILY_CPR_FR24])
REFINED_MERGED_DAILY_CPR_FR24_IDS = '/'.join([REFINED_MERGED_DAILY_CPR_FR24, IDS])

OVERNIGHT = 'overnight'
OVERNIGHT_CPR_FR24 = '_'.join([OVERNIGHT, CPR_FR24])

REFINED_MERGED_OVERNIGHT_CPR_FR24 = '/'.join([REFINED, MERGED, OVERNIGHT_CPR_FR24])
REFINED_MERGED_OVERNIGHT_CPR_FR24_IDS = '/'.join([REFINED_MERGED_OVERNIGHT_CPR_FR24, IDS])

REFINED_MERGED_APDS_CPR_FR24 = '/'.join([REFINED, MERGED, APDS_CPR_FR24])
REFINED_MERGED_APDS_CPR_FR24_IDS = '/'.join([REFINED_MERGED_APDS_CPR_FR24, IDS])
...
PRODUCTS_SYNTH_POSITIONS_CPR = '/'.join([PRODUCTS, SYNTH_POSITIONS, CPR])
PRODUCTS_SYNTH_POSITIONS_FR24 = '/'.join([PRODUCTS, SYNTH_POSITIONS, FR24])
PRODUCTS_SYNTH_POSITIONS_CPR_FR24 = '/'.join([PRODUCTS, SYNTH_POSITIONS, CPR_FR24])
...
VALID_DATA_TYPES = {APDS, CPR, FR24, CPR_FR24, REFINED_CPR, REFINED_FR24, REFINED_APDS,
                    ...
                    PRODUCTS_SYNTH_POSITIONS_CPR, PRODUCTS_SYNTH_POSITIONS_FR24,
                    PRODUCTS_SYNTH_POSITIONS_CPR_FR24, PRODUCTS_INTERSECTIONS_SECTOR_CPR,
