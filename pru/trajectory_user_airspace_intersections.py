...
from .gis_database_interface import find_2D_user_airspace_intersections
...
def find_trajectory_user_airspace_intersections(smooth_traj):
    """
    Find airspace usersairspace intersection positions from a smoothed trajectory
    ...
    lats, lons, sector_ids = find_2D_user_airspace_intersections(smooth_traj.flight_id,
