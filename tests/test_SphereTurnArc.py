...
from via_sphere import Point3d, distance_radians, Arc3d
from pru.trajectory_functions import rad2nm
from pru.SphereTurnArc import *
...
class TestSphereTurnArc(unittest.TestCase):
    ...
    def test_SphereTurnArc_init(self):
        ...
        assert_almost_equal(distance_radians(pos_1, turn_0.centre),
                            turn_0.radius)
        assert_almost_equal(distance_radians(pos_1, turn_0.finish), 0.0,
                            decimal=6)
    ...
    # def test_repr(self):
    #     ecef_point_0 = Point3d(ECEF_ICOSAHEDRON[1])
    #     ecef_point_1 = Point3d(ECEF_ICOSAHEDRON[2])
    #     ecef_point_2 = Point3d(ECEF_ICOSAHEDRON[3])
    #     arc_0 = Arc3d(ecef_point_0, ecef_point_1)
    #     arc_1 = Arc3d(ecef_point_1, ecef_point_2)
    #
    #     turn_0 = SphereTurnArc(arc_0, arc_1, TWENTY_NM)
    #     repr_0 = repr(turn_0)
    #     self.assertEqual('SphereTurnArc([[', repr_0[:10])
    #
    # def test_str(self):
    #     ecef_point_0 = Point3d(ECEF_ICOSAHEDRON[1])
    #     ecef_point_1 = Point3d(ECEF_ICOSAHEDRON[2])
    ...
    #     turn_0 = SphereTurnArc(arc_0, arc_1, TWENTY_NM)
    #     str_0 = str(turn_0)
    #     self.assertEqual('SphereTurnArc(', str_0[:8])
